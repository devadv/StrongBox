...
public class GoogleDriveModel1 {
	...
	public static void setFileID(String fileID) {
		GoogleDriveModel1.fileID = fileID;
	}
	...
	public static void setFolderID(String folderID) {
		GoogleDriveModel1.folderID = folderID;
	}
	...
	private static void downloadRAWData(String fileID) throws IOException {
		Drive service = getDriveService();
		String fileId = fileID;
		OutputStream outputStream = new ByteArrayOutputStream();
		service.files().get(fileId)
